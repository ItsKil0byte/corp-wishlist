    ...
    <section className="w-full max-w-5xl mx-auto py-12 px-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        {steps.map((step, index) => (
          <div
            key={index}
            className="flex flex-col items-center text-center p-8 rounded-2xl bg-white/50 backdrop-blur-sm border border-main-theme/5 hover:border-main-theme/20 transition-all hover:-translate-y-1 shadow-sm"
          >
