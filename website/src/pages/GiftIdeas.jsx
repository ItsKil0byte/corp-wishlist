    ...
    <>
      ...
      <div className="min-h-[70vh] max-w-[1440px] mx-auto flex flex-col items-center justify-center text-center px-4 py-24">
        <div className="relative mb-12" data-reveal>
          <div className="size-32 bg-main-theme-lite dark:bg-main-theme dark:text-white rounded-[2.5rem] flex items-center justify-center shadow-xl rotate-3 transform group-hover:rotate-0 transition-transform duration-500">
            <Gift className="size-16 text-main-theme dark:text-white" />
          </div>
        ...
        <div className="space-y-6 max-w-3xl" data-reveal data-reveal-delay="1">
          ...
          <p className="text-xl md:text-2xl text-gray-500 font-medium leading-relaxed">
            Совсем скоро здесь появятся авторские подборки подарков на все
            случаи жизни! Мы усердно наполняем базу самыми крутыми идеями.
          </p>
        </div>
